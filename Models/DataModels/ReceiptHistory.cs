...
{
    public class ReceiptHistory : Notifier
    {
        ...
        public bool Equals(ReceiptHistory other)
        {
        ...
        {
            return this.Equals(obj as ReceiptHistory);
        }
        ...
        public static bool operator ==(ReceiptHistory x, ReceiptHistory y)
        {
